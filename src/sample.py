...
# Pythonic API
response['YES'] = fuzz.trimf(response.universe, [60, 65, 70])
...
rule3 = ctrl.Rule(antcdnt[0]['nice'] & antcdnt[1]['nice'] & antcdnt[2]['nice'] & antcdnt[3]['nice'], response['YES'])
...
# Входные данные
make_resp.input['Java'] = 43.18
make_resp.input['Python'] = 91.54
